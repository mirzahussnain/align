      ...
      <div className="flex w-full flex-col-reverse gap-2 sm:w-auto sm:flex-row sm:items-center sm:gap-3">
        {!isBasics && (
          <button
            ...
            onClick={handleSkip}
            disabled={isPending}
            className="min-h-11 w-full rounded-xl px-4 py-2.5 text-sm font-semibold text-slate-600 transition-colors hover:bg-slate-100 hover:text-slate-950 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#6757d9]/35 disabled:opacity-50 sm:w-auto"
          >

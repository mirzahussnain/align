      ...
      <div className="space-y-3">
        <p className="text-xs text-slate-500 leading-relaxed">
          {targetRoleTitle
            ...
            : "No specific target title was found in the header or summary. Clearly state your targeted title (e.g. 'Warehouse Team Leader', 'Staff Nurse', 'Senior Frontend Engineer') at the very top of your CV."}
        </p>
        {targetRoleTitle && (
